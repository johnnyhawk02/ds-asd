...
const AdaptedEDAQ8Page: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-gray-100">
              <th className="border p-3 text-left">Original EDA-Q8 Item</th>
              <th className="border p-3 text-left">Adapted Version (Non-Verbal Focused)</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className="border p-3">Obsessively resists and avoids ordinary demands and requests.</td>
              <td className="border p-3">Strongly resists everyday requests through non-verbal actions (e.g., flopping to the ground, turning away, covering face, or running off).</td>
            </tr>
            <tr className="bg-gray-50">
              <td className="border p-3">Is driven by the need to be in charge.</td>
              <td className="border p-3">Insists on controlling routines or interactions (e.g., gets upset if others change their preferred order of activities or try to lead).</td>
            </tr>
            <tr>
              <td className="border p-3">Tells other children how they should behave, but does not feel these rules apply to him/herself.</td>
              <td className="border p-3">Directs others' actions using gestures (e.g., pushing, pulling, or pointing) but resists being directed or corrected themselves.</td>
            </tr>
            <tr className="bg-gray-50">
              <td className="border p-3">Has difficulty complying with demands unless they are carefully presented.</td>
              <td className="border p-3">Only follows requests if presented in a specific way (e.g., during play, as a choice, or when they initiate the task).</td>
            </tr>
            <tr>
              <td className="border p-3">Seems unaware of the differences between him/herself and authority figures (e.g., parents, teachers, police).</td>
              <td className="border p-3">Treats adults like peers (e.g., pulls adults' hands, climbs on them, or expects them to follow their lead without delay).</td>
            </tr>
            <tr className="bg-gray-50">
              <td className="border p-3">Mood changes very rapidly (e.g., switches from affectionate to angry in an instant).</td>
              <td className="border p-3">Shows sudden mood shifts (e.g., from calm to distressed or angry) when faced with requests or changes in routine.</td>
            </tr>
            <tr>
              <td className="border p-3">Uses outrageous or shocking behaviour to get out of doing something.</td>
              <td className="border p-3">Uses dramatic behaviors to avoid tasks (e.g., screaming, falling to the floor, or throwing objects) when asked to do something.</td>
            </tr>
            <tr className="bg-gray-50">
              <td className="border p-3">Has bouts of extreme emotional responses to small events (e.g., crying/giggling, becoming furious).</td>
              <td className="border p-3">Displays intense emotional reactions (e.g., loud crying, screaming, excessive giggling, or anger) to minor events or disruptions in routine.</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="mt-6">
        <h2 className="text-xl font-semibold mb-3">Benefits of the Proposed Adapted Questionnaire</h2>
        <ul className="list-disc ml-6 space-y-2">
