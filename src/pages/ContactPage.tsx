  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mb-2">
            Email: <span className="text-blue-600">contact@ds-asd-support.org</span>
          </p>
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-800 mb-3">Stay Connected</h2>
      ...
      <div className="bg-blue-50 rounded-lg p-6">
        <h2 className="text-xl font-semibold text-gray-800 mb-3">Contact Form Coming Soon</h2>
