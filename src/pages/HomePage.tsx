...
const HomePage = () => {
  return (
    <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="py-16 mb-16 bg-background rounded-3xl px-6 md:px-12 shadow-sm">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-text mb-6 leading-tight">
            Supporting <span className="text-primary">Down Syndrome</span> and <span className="text-primary">Autism</span> Journey
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-5">
            <Link 
              to="/about" 
              className="px-8 py-4 bg-primary text-white font-medium rounded-lg hover:bg-opacity-90 transition duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1"
            >
              Learn More
            </Link>
            <Link 
              to="/resources" 
              className="px-8 py-4 bg-white text-primary font-medium rounded-lg border border-primary hover:bg-gray-50 transition duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1"
            >
              View Resources
            </Link>
          </div>
      ...
      <div className="mb-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl shadow-md p-8 hover:shadow-xl transition duration-300 transform hover:-translate-y-1">
            ...
            <h3 className="text-2xl font-semibold text-text mb-3">Understanding DS-ASD</h3>
            <p className="text-text/80 mb-5 leading-relaxed">
          ...
          <div className="bg-white rounded-xl shadow-md p-8 hover:shadow-xl transition duration-300 transform hover:-translate-y-1">
            ...
            <h3 className="text-2xl font-semibold text-text mb-3">Understanding PDA</h3>
            <p className="text-text/80 mb-5 leading-relaxed">
          ...
          <div className="bg-white rounded-xl shadow-md p-8 hover:shadow-xl transition duration-300 transform hover:-translate-y-1">
            ...
            <h3 className="text-2xl font-semibold text-text mb-3">Adapted Resources</h3>
            <p className="text-text/80 mb-5 leading-relaxed">
      ...
      {/* Call to Action */}
      <div className="bg-primary text-white rounded-2xl py-12 px-8 mb-20 shadow-lg">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link
            to="/contact"
            className="inline-block px-8 py-4 bg-white text-primary font-medium rounded-lg hover:bg-gray-50 transition duration-300 shadow-md"
          >
            Get in Touch
          </Link>
        </div>
