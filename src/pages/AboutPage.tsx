  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="prose lg:prose-lg text-gray-700 max-w-none">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">Understanding Down Syndrome</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">Understanding Autism Spectrum Disorder</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">When Down Syndrome and Autism Co-occur</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">Support and Resources</h2>
        <p className="mb-4">
